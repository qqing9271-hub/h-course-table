...
const styles = StyleSheet.create({
  ...
  nav: { fontSize: 26, color: '#4a90e2', paddingHorizontal: 10 },
  title: { fontSize: 16, fontWeight: '700' },
  weekRow: { flexDirection: 'row', marginBottom: 6 },
  weekTxt: { flex: 1, textAlign: 'center', color: '#888' },
  grid: { flexDirection: 'row', flexWrap: 'wrap' },
  cell: { width: '14.28%', height: 40, alignItems: 'center', justifyContent: 'center' },
  dayTxt: { fontSize: 15 },
  close: { marginTop: 12, backgroundColor: '#ddd', borderRadius: 8, padding: 10, alignItems: 'center' },
  closeTxt: { color: '#333' },
});
